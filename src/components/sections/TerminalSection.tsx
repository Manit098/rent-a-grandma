    ...
    <section className="max-w-container-max mx-auto px-margin-mobile md:px-margin-desktop py-section-gap overflow-hidden">
      <div className="glass-terminal rounded-[3rem] p-1 overflow-hidden relative group">
        ...
        <div className="flex items-center gap-3 p-8 bg-white/5 border-b border-white/5 relative z-10">
          ...
          <span className="text-white/20 font-mono text-[10px] ml-10 tracking-[0.4em] uppercase">top_secret // matriarch_v4.2.sh // session_id_9921</span>
        </div>
        {/* Terminal Body */}
        <div className="p-16 md:p-32 font-mono text-xl md:text-2xl relative z-10 flicker">
          ...
          <div className="mb-20">
            <div className="text-[#ff5f56] font-bold mb-8 flex items-center gap-4 text-sm tracking-widest uppercase">
              <span className="material-symbols-outlined text-3xl">emergency_home</span>
              CRITICAL ADVICE INBOUND:
            </div>
            <div className="text-white/90 leading-relaxed max-w-4xl border-l-2 border-[#ff5f56]/30 pl-12 py-4 text-2xl italic">
